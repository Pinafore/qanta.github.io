...
|---|---|
| [Pinafore/qb](https://github.com/Pinafore/qb) | Main QA system used in exhibition matches — large, actively developed |
| [Pinafore/qanta-codalab](https://github.com/Pinafore/qanta-codalab) | Simplified system designed for inspection, extension, and leaderboard submission |
...
Submit your system to the **[CodaLab leaderboard](https://codalab.lisn.upsaclay.fr/)**. Example worksheets and baseline submissions are available in [Pinafore/qanta-codalab](https://github.com/Pinafore/qanta-codalab).
